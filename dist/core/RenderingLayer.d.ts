...
export declare class RenderingLayer implements IRenderingLayer {
     ...
     */
    updateSize(width: number, height: number, pixelScale?: number, updateStyleSizeCallback?: UpdateStyleSizeCallback | null): void;
    clear(): void;
...
export declare type UpdateStyleSizeCallback = {
