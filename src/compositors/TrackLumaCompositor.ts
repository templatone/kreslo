import { CustomCompositor, CompositeOperationCallback } from "./CustomCompositor";


export class TrackLumaCompositor extends CustomCompositor {
    constructor(width: number, height: number, inverted: boolean = false) {
        const operation = (base: Uint8ClampedArray, brending: Uint8ClampedArray): Uint8ClampedArray => {
